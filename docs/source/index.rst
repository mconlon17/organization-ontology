...
.. note::
   ...
   These pages are a demonstration of the abilities of 
   `ReadTheDocs <https://readthedocs.org/>`_, 
   `Sphinx <https://www.sphinx-doc.org/en/master/index.html>`_, and 
   `RestructuredText <https://docutils.sourceforge.io/rst.html>`_ 
   for documenting the Oganization Ontology.  It is a work in
   progress.
...
An organization is a group of people with a purpose.  It is not merely a group of people with
no purpose -- this would be a collection of people,not an organization.  The purpose
